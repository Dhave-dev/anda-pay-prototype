...
html = re.sub(pattern, replace_svg, html, flags=re.DOTALL)

# Now, update the driver list in #screen-tab-search
old_list_pattern = r'<div class="hist-card"[^>]*>.*?</div>\s*</div>\s*</div>\s*<button class="st-scan-btn"'

new_list_html = """<div class="st-drv-card" onclick="goTo('driver-profile')">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar-1.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">João Mbemba</div><div class="st-drv-sub">AOL-2847-X · EV Bike</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <div class="st-drv-card" onclick="goTo('driver-profile')">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">Maria Domingos</div><div class="st-drv-sub">AOL-2847-X · Vendor</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <div class="st-drv-card" onclick="goTo('driver-profile')">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar 5.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">Paulo Tchilemba</div><div class="st-drv-sub">AOL-3901-K · Tuktuk</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <div class="st-drv-card" onclick="goTo('driver-profile')">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar3.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">Paulo Tchilemba</div><div class="st-drv-sub">AOL-7734-B · EV Bike</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <div class="st-drv-card" onclick="goTo('driver-profile')">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar 4.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">Carlos Lopes</div><div class="st-drv-sub">AOL-1183-M · Tuktuk</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
          <div class="st-drv-card" onclick="goTo('driver-profile')" style="margin-bottom:80px;">
            <div class="st-drv-av" style="background:transparent; overflow:hidden;"><img src="Assets/Avatar.svg" style="width:100%;height:100%;object-fit:cover;"></div>
            <div class="st-drv-info"><div class="st-drv-name">Paulo Tchilemba</div><div class="st-drv-sub">AOL-2847-X · EV Bike</div></div>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="#575757" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
        </div>
      </div>
      <button class="st-scan-btn" """

html = re.sub(old_list_pattern, new_list_html, html, flags=re.DOTALL)
